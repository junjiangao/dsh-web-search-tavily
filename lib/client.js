window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var credentialStyle = { fontSize: "12px", margin: "0 0 12px", opacity: 0.85 };
		...
		function TavilyCard(props, face) {
		  ...
		  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_dsh_client_ui_primitives.SettingsForm, { labels: face.labels, state, onSave: face.actions.save, onDiscard: face.actions.discard, children: [
		    state.credential === void 0 ? null : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { style: credentialStyle, "data-plugin-credential-status": true, children: state.credential.configured ? `${face.t("credentialConfigured")}${state.credential.ref}` : `${face.t("credentialUnset")}${state.credential.ref}` }),
