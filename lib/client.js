window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var FormModel = class {
		  ...
		  failed = false;
		  failureMessage;
		  constructor(scope, specs, credential) {
		    this.scope = scope;
		      ...
		      if (spec.kind === "credential") {
		        if (staged.kind === "set" && typeof staged.value === "string" && staged.value.trim() !== "") {
		          ...
		          plan.push({ field, write: async () => {
		            ...
		            if (!result.ok && result.message !== void 0) this.failureMessage = result.message;
		            return result.ok;
		          } });
		        }
		        continue;
		...
		var READ_RETRY_DELAY_MS = 1e3;
		var READ_RETRY_MAX_ATTEMPTS = 6;
		function refusal(message) {
		  return message === void 0 ? { ok: false } : { ok: false, message };
		}
		var TavilyCardController = class {
		  ...
		  readTimer;
		  constructor(scope, legacyFace, modernFace, retry = {
		    delayMs: READ_RETRY_DELAY_MS,
		    maxAttempts: READ_RETRY_MAX_ATTEMPTS
		  }) {
		    this.scope = scope;
		      ...
		      return {
		        describe: async (refs) => {
		          try {
		            ...
		            return response.result.ok ? { ok: true, views: response.result.value.credentials } : refusal(response.result.error?.message);
		          } catch (error) {
		      ...
		      return {
		        describe: async (refs) => {
		          try {
		            ...
		            return response.ok ? { ok: true, views: response.value } : refusal(response.error?.message);
		          } catch (error) {
		            return refusal(error instanceof Error ? error.message : String(error));
		          }
		        },
		   ...
		   */
		  async readCredential(attempt = 0) {
		    clearTimeout(this.readTimer);
		    this.readTimer = void 0;
		    ...
		    if (face === void 0 || response === void 0 || !response.ok || ref !== this.credentialRef()) {
		...
		function CardShell(props) {
		  ...
		  return (0, import_react.createElement)(
		    "li",
		    { className: `tavily-card${open ? " tavily-cardOpen" : ""}` },
		    (0, import_react.createElement)("style", null, CARD_CSS),
		    (0, import_react.createElement)(
		      ...
		      (0, import_react.createElement)(
		        "span",
		        { className: "tavily-headText" },
		        (0, import_react.createElement)("span", { className: "tavily-name" }, title),
		        (0, import_react.createElement)("span", { className: "tavily-description" }, description)
		      ),
		      state.dirty ? (0, import_react.createElement)("span", { className: "tavily-pending" }, t("unsaved")) : null,
		      (0, import_react.createElement)(import_dsh_client_ui_primitives.IconChevronDownOutline14, {
		        className: `tavily-chevron${open ? " tavily-chevronOpen" : ""}`
		      })
		    ),
		    open ? (0, import_react.createElement)(
		      "div",
		      { className: "tavily-body" },
		      !state.writable ? (0, import_react.createElement)("p", { className: "tavily-readOnly", role: "status" }, t("readOnly")) : null,
		      ...children,
		      (0, import_react.createElement)(
		        "div",
		        { className: "tavily-footer" },
		        state.failed ? (0, import_react.createElement)(
		          "p",
		          { className: "tavily-failed", role: "status" },
		...
		function TextRow(props) {
		  ...
		  return (0, import_react.createElement)(
		    "div",
		    { className: "tavily-field" },
		    (0, import_react.createElement)(
		      "div",
		      { className: "tavily-head" },
		      (0, import_react.createElement)("label", { className: "tavily-label", htmlFor: id }, label),
		      overridden ? (0, import_react.createElement)(
		        "span",
		        { className: "tavily-badges" },
		        (0, import_react.createElement)("span", { className: "tavily-badge" }, t("overridden")),
		        (0, import_react.createElement)("button", {
		          type: "button",
		    ...
		    (0, import_react.createElement)(
		      "p",
		      { className: invalid ? "tavily-invalid" : "tavily-hint" },
		  ...
		  return (0, import_react.createElement)(
		    ...
		    (0, import_react.createElement)(
		      ...
		      (0, import_react.createElement)(
		        "span",
		        { className: "tavily-badges" },
		        (0, import_react.createElement)("span", { className: configured ? "tavily-badge" : "tavily-badgeMuted" }, stateLabel)
		      )
		    ),
		    (0, import_react.createElement)("input", {
		      id,
		    ...
		    (0, import_react.createElement)("p", { className: "tavily-hint" }, hint)
		  );
		}
		...
		function TavilyCard(props) {
		  ...
		  return (0, import_react.createElement)(CardShell, {
		    ...
		    children: [
		      state.apiKey.configured ? null : (0, import_react.createElement)("div", { className: "tavily-notice", role: "status" }, t("keylessNotice")),
