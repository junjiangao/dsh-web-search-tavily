...
export const Config: z<Config> = z.object({
  ...
  baseURL: z.string(),
  searchDepth: z.union(['ultra-fast', 'fast', 'basic', 'advanced'] as const).default(TAVILY_DEFAULT_SEARCH_DEPTH),
  ...
  includeAnswer: z.union([z.boolean(), z.union(['basic', 'advanced'] as const)]),
  includeRawContent: z.union([z.boolean(), z.union(['markdown', 'text'] as const)]),
