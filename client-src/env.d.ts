...
declare module '@deepseek-ai/dsh-client-ui-primitives' {
  ...
  export function PluginCard(props: PluginCardProps): any
  export function SecretField(props: SecretFieldProps): any
  export function ValueField(props: ValueFieldProps): any
}
